...
`;
    ...
    return (
        <div className="fixed bottom-4 right-4 w-96 max-h-[600px] h-[calc(100vh-100px)] bg-white rounded-2xl shadow-2xl z-50 flex flex-col font-sans transition-all duration-300 transform scale-100 opacity-100">
            {/* Header */}
            <div className="flex justify-between items-center p-4 bg-gradient-to-r from-blue-700 to-teal-500 text-white rounded-t-2xl shadow-md">
                <div className="flex items-center space-x-2">
                    <FaRobot className="w-6 h-6" />
                    <h3 className="font-semibold text-lg">TourGuide AI</h3>
                </div>
