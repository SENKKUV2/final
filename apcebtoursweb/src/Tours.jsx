        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <h3 className="text-2xl font-semibold text-white mb-4">AP Cebu Tours & Transport</h3>
              <p className="text-gray-300 mb-6 leading-relaxed font-normal">Your trusted partner for exploring the beautiful islands of Cebu and beyond. We specialize in creating personalized travel experiences that showcase the best of Philippine hospitality.</p>
              <div className="flex space-x-4">
                {["M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z", "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z", "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"].map((path, i) => (
                  <a key={i} href="#" className="w-10 h-10 rounded-xl flex items-center justify-center transition-all hover:scale-105" style={{ backgroundColor: "#00355f" }}>
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d={path} /></svg>
                  </a>
                ))}
              </div>
            </div>
            <div>
              ...
              {["All Tours", "Book Online", "Custom Packages", "Contact Us"].map((link, i) => (
                <li key={i} className="space-y-3">
                  <a href="#" className="text-gray-300 transition-colors font-normal" style={{ color: "#a0aec0" }}
                    onMouseEnter={(e) => e.target.style.color = "#eec218"} onMouseLeave={(e) => e.target.style.color = "#a0aec0"}
                  >{link}</a>
                </li>
              ))}
            </div>
            <div>
              ...
              <div className="space-y-3 text-gray-300">
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5" style={{ color: "#eec218" }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  <span style={{ color: "#a0aec0" }}>Cebu City, Philippines</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5" style={{ color: "#eec218" }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  <span style={{ color: "#a0aec0" }}>+63 XXX XXX XXXX</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5" style={{ color: "#eec218" }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  <span style={{ color: "#a0aec0" }}>info@apcebutours.com</span>
                </div>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-700 mt-12 pt-8 text-center"><p className="text-gray-400 font-normal">© 2025 AP Cebu Tours & Transport. All rights reserved.</p></div>
        </div>
      </footer>
    </div>
  );
...
const TourDetailsModal = ({ showTourDetailsModal, setShowTourDetailsModal, tour, handleBookNow, user }) => {
  ...
  const tabs = [
    ...
    { id: 'highlights', label: 'Highlights', icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' },
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-3xl max-w-5xl w-full max-h-[95vh] overflow-hidden shadow-2xl transform animate-slideUp"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header with Gradient Background */}
        <div className="relative bg-gradient-to-r from-[#00355f] via-[#004a7c] to-[#00355f] px-8 py-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4 text-white/90">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-sm">{tour.rating || 4.5}</span>
                </div>
              </div>
            </div>
            <button
              onClick={() => setShowTourDetailsModal(false)}
              className="text-white/80 hover:text-white hover:bg-white/10 p-2 rounded-full transition-all duration-300 hover:scale-110"
              aria-label="Close"
            >
          ...
          <div className="absolute -bottom-4 left-8">
            <div className="bg-[#eec218] text-[#00355f] px-6 py-3 rounded-2xl font-bold text-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
              {tour.formattedPrice}
            </div>
          </div>
        </div>
        ...
        {/* Content Container */}
        <div className="overflow-y-auto max-h-[calc(95vh-140px)]" ref={modalRef}>
          <div className="p-8 pt-12">
            {/* Image Gallery Section */}
            <div className="mb-8">
              {/* Main Image with Loading State */}
              <div className="relative mb-6 group">
                <div className={`relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 ${imageLoading ? 'opacity-50' : 'opacity-100'}`}>
                  <img
                    src={activeImage}
                    alt={tour.title}
                    className="w-full h-96 lg:h-[28rem] object-cover transition-transform duration-700 group-hover:scale-105"
                    onError={(e) => {
                  ...
                  {imageLoading && (
                    <div className="absolute inset-0 flex items-center justify-center bg-gray-100">
                      <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#00355f]"></div>
                    </div>
                  )}
                  ...
                  <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg">
                    <div className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                      ...
                      <span>Max: {tour.max_capacity || 20} people</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex overflow-x-auto gap-4 pb-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  ...
                  <div className="flex-shrink-0">
                    <img
                      src={tour.image}
                      alt="Main"
                      className={`w-20 h-20 object-cover rounded-xl shadow-md cursor-pointer transition-all duration-300 hover:scale-110 border-2 ${
                        activeImage === tour.image ? "border-[#eec218] shadow-lg" : "border-transparent hover:border-gray-300"
                      }`}
                  ...
                  {tour.sub_images.map((img, i) => (
                    <div key={i} className="flex-shrink-0">
                      <img
                        ...
                        alt={`Gallery ${i + 1}`}
                        className={`w-20 h-20 object-cover rounded-xl shadow-md cursor-pointer transition-all duration-300 hover:scale-110 border-2 ${
                          activeImage === img ? "border-[#eec218] shadow-lg" : "border-transparent hover:border-gray-300"
                        }`}
              ...
              <div className="flex border-b border-gray-200">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`flex items-center space-x-2 px-6 py-4 font-semibold text-sm transition-all duration-300 border-b-2 ${
                      activeTab === tab.id
                        ? "border-[#eec218] text-[#00355f] bg-[#eec218]/10"
                        : "border-transparent text-gray-500 hover:text-[#00355f] hover:border-gray-300"
                    }`}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-8">
              {activeTab === 'overview' && (
                <div className="animate-fadeIn space-y-6">
                  <div>
                    <h3 className="text-2xl font-bold text-[#00355f] mb-4">Tour Overview</h3>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-100">
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex justify-between">
                          ...
                          <span className="font-medium text-[#00355f]">{tour.max_capacity || 20} people</span>
                        </li>
                      </ul>
                    </div>
              ...
              {activeTab === 'highlights' && tour.highlights?.length > 0 && (
                <div className="animate-fadeIn">
                  <h3 className="text-2xl font-bold text-[#00355f] mb-6">Tour Highlights</h3>
                  <div className="grid gap-4">
                    {tour.highlights.map((highlight, i) => (
                      <div key={i} className="flex items-start space-x-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100 hover:shadow-md transition-shadow duration-300">
              ...
              {activeTab === 'features' && tour.features?.length > 0 && (
                <div className="animate-fadeIn">
                  <h3 className="text-2xl font-bold text-[#00355f] mb-6">What's Included</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    {tour.features.map((feature, i) => {
                      ...
                      return (
                        <div key={i} className="flex items-start space-x-3 p-4 bg-white rounded-xl border border-gray-200 hover:shadow-md hover:border-[#eec218] transition-all duration-300">
                          <div className="flex-shrink-0 w-6 h-6 bg-[#eec218] rounded-full flex items-center justify-center">
                            <svg className="w-3 h-3 text-[#00355f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="sticky bottom-0 bg-white pt-6 border-t border-gray-200">
              <button
                className={`w-full py-4 px-8 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-[#00355f]/20 ${
                  tour.available
                    ? "bg-gradient-to-r from-[#00355f] to-[#004a7c] text-white hover:shadow-2xl hover:shadow-[#00355f]/30"
              ...
              >
                {tour.available ? (
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <span>{user ? "Book This Tour Now" : "Sign In to Book Tour"}</span>
                  </div>
                ) : (
