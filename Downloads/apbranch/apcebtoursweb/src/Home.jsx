...
// Note: Ensure your router is set up in App.jsx with the following routes:
// <BrowserRouter>
//   <Routes>
  ...
  const services = [
    ...
    },
    {
      icon: (
        <div className="w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-transform duration-300" style={{ backgroundColor: '#00355f' }}>
          <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 3v18m-9-9h18" />
          </svg>
        </div>
      ),
      title: "Island Tours",
