  ...
  return (
    <SafeAreaView style={styles.drawerContainer}>
      <View style={styles.drawerHeader}>
        <MaterialIcons name="admin-panel-settings" size={40} color="#eec218" />
      ...
      >
        <MaterialIcons
          name="settings"
          size={24}
          color={pathname === '/(drawer)/settings' ? '#eec218' : '#6b7280'}
        />
        <Text
          style={[
            styles.drawerItemText,
      ...
      <Drawer
        ...
        screenOptions={{
          ...
          headerStyle: {
            ...
            shadowColor: '#00355f',
            borderBottomWidth: 1,
            borderBottomColor: 'rgba(238, 194, 24, 0.3)',
          },
          headerTintColor: '#eec218',
          headerTitleStyle: {
            fontWeight: '600',
            fontSize: 18,
            color: '#00355f',
...
const styles = StyleSheet.create({
  ...
  settingsItem: { 
    borderTopWidth: 1, 
    borderTopColor: 'rgba(238, 194, 24, 0.3)', 
    marginTop: 10, 
    paddingTop: 20 
  },
  drawerFooter: { 
