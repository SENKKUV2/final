...
export default function AdminLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.user) {
        ...
        // If fetching the role fails or the role is not 'admin'
        ...
        // If the role check passes, navigate to the admin dashboard
      ...
      // Use a type guard to ensure the error object has a message property
  ...
  return (
    <>
      <StatusBar barStyle="light-content" backgroundColor="#00355f" />
      <KeyboardAvoidingView
          ...
          <View style={styles.content}>
            ...
            <View style={styles.header}>
              <View style={styles.logoContainer}>
                <MaterialIcons name="admin-panel-settings" size={52} color="#eec218" />
              </View>
            ...
            <View style={styles.form}>
              <View style={styles.inputContainer}>
                <MaterialIcons name="email" size={22} color="#eec218" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
              ...
              <View style={styles.inputContainer}>
                <MaterialIcons name="lock" size={22} color="#eec218" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
...
const styles = StyleSheet.create({
  ...
  backgroundDecorationSmall: {
    ...
    height: 120,
    borderRadius: 60,
    backgroundColor: 'rgba(238, 194, 24, 0.03)',
  },
  header: {
    alignItems: 'center',
    marginBottom: 40,
