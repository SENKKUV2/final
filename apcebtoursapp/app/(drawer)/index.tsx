...
const s = StyleSheet.create({
  ...
  retry: { marginTop: 16, backgroundColor: '#00355F', padding: 8, borderRadius: 6 },
  ...
  notification: { backgroundColor: '#FFFFFF', padding: 8, borderRadius: 20, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  badge: { position: 'absolute', top: 2, right: 2, backgroundColor: '#EEC218', borderRadius: 8, width: 14, height: 14, justifyContent: 'center', alignItems: 'center' },
  ...
  card: { backgroundColor: '#FFFFFF', borderRadius: 10, padding: 12, width: '48%', marginBottom: 10, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1 },
  ...
  actionCard: { backgroundColor: '#FFFFFF', borderRadius: 10, padding: 12, width: '48%', alignItems: 'center', marginBottom: 12, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1 },
  actionText: { marginTop: 6, fontSize: 12, fontWeight: '600', color: '#555' },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  viewAll: { color: '#EEC218', fontWeight: '600', fontSize: 12 },
  bookingCard: { backgroundColor: '#FFFFFF', borderRadius: 10, padding: 12, marginBottom: 8, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1 },
  bookingLeft: { flex: 1 },
  ...
  noDataCard: { backgroundColor: '#FFFFFF', borderRadius: 10, padding: 16, alignItems: 'center', marginTop: 8, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1 },
  noDataSub: { fontSize: 11, color: '#aaa', marginTop: 3 },
  manageCard: { backgroundColor: '#FFFFFF', borderRadius: 10, marginBottom: 12, overflow: 'hidden', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1 },
  ...
  rating: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#EEC21830', paddingHorizontal: 6, paddingVertical: 3, borderRadius: 8 },
  ratingText: { fontSize: 11, color: '#333', marginLeft: 3, fontWeight: '600' },
  managePrice: { fontSize: 14, color: '#EEC218', fontWeight: '600', marginTop: 4 },
...
const ms = StyleSheet.create({
  ...
  modal: { width: '95%', maxWidth: 360, backgroundColor: '#FFFFFF', borderRadius: 12, padding: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, elevation: 5, maxHeight: '80%' },
  ...
  tourPrice: { fontSize: 16, fontWeight: '600', color: '#EEC218' },
  ...
  detailIcon: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#00355F20', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  ...
  actionText: { color: '#FFFFFF', fontWeight: '600', fontSize: 12, marginLeft: 5 },
  notificationCard: { 
