...
const styles = StyleSheet.create({
  ...
  loadingCard: { backgroundColor: '#ffffff', borderRadius: 24, padding: 40, alignItems: 'center', shadowColor: '#6366f1', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.15, shadowRadius: 20, elevation: 10 },
  loadingText: { fontSize: 18, fontWeight: '600', color: '#334155', marginTop: 16 },
  ...
  errorCard: { backgroundColor: '#ffffff', borderRadius: 24, padding: 32, alignItems: 'center', shadowColor: '#f72585', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.15, shadowRadius: 20, elevation: 10 },
  ...
  retryButton: { flexDirection: 'row', backgroundColor: '#6366f1', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 16, alignItems: 'center' },
  ...
  kpiCard: { flex: 1, backgroundColor: '#ffffff', borderRadius: 20, padding: 20, shadowColor: '#64748b', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 4 },
  primaryKpi: { borderLeftWidth: 4, borderLeftColor: '#06d6a0' },
  secondaryKpi: { borderLeftWidth: 4, borderLeftColor: '#6366f1' },
  kpiIconContainer: { marginBottom: 12 },
  kpiValue: { fontSize: 24, fontWeight: '800', color: '#1e293b', marginBottom: 4 },
  ...
  chartTitle: { fontSize: 20, fontWeight: '700', color: '#1e293b' },
  chartSubtitle: { fontSize: 14, color: '#64748b', marginTop: 4 },
  chartContainer: { backgroundColor: '#ffffff', borderRadius: 24, padding: 20, shadowColor: '#64748b', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 6 },
  ...
  tableContainer: { backgroundColor: '#ffffff', borderRadius: 24, padding: 20, shadowColor: '#64748b', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 6 },
  locationRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#f1f5f9' },
  ...
  rankText: { fontSize: 14, fontWeight: '700', color: '#475569' },
  locationIndicator: { width: 12, height: 12, borderRadius: 6, marginRight: 16 },
  locationInfo: { flex: 1 },
  ...
  locationCount: { fontSize: 20, fontWeight: '700', color: '#6366f1' },
  ...
  statCard: { flex: 1, minWidth: '45%', backgroundColor: '#ffffff', borderRadius: 20, padding: 24, alignItems: 'center', shadowColor: '#64748b', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 4 },
  statValue: { fontSize: 28, fontWeight: '800', color: '#1e293b', marginTop: 12, marginBottom: 4 },
  statLabel: { fontSize: 13, color: '#64748b', fontWeight: '500', textAlign: 'center' },
  exportSection: { marginHorizontal: 20, marginBottom: 24, backgroundColor: '#ffffff', borderRadius: 24, padding: 24, shadowColor: '#64748b', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 6 },
  exportHeader: { marginBottom: 20 },
  exportTitle: { fontSize: 20, fontWeight: '700', color: '#1e293b' },
  exportSubtitle: { fontSize: 14, color: '#64748b', marginTop: 4 },
  exportButton: { flexDirection: 'row', backgroundColor: '#6366f1', paddingHorizontal: 24, paddingVertical: 16, borderRadius: 16, alignItems: 'center', justifyContent: 'center' },
  exportButtonDisabled: { backgroundColor: '#a5b4fc', opacity: 0.7 },
  ...
  exportProgressText: { color: '#334155', fontSize: 14, marginLeft: 8 },
  exportFeatures: { marginTop: 24, paddingTop: 20, borderTopWidth: 1, borderTopColor: '#f1f5f9' },
