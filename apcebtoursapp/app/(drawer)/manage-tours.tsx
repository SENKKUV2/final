...
const s = StyleSheet.create({
  ...
  tourPrice: { fontSize: 20, fontWeight: 'bold', color: '#2E7D32' },
  ...
  comboTag: { backgroundColor: '#FFF3E0' },
  typeText: { fontSize: 12, fontWeight: '600', color: '#1976D2' },
  comboText: { color: '#F57C00' },
  ...
  editButtonText: { color: '#1976D2', fontWeight: '600', fontSize: 16 },
  ...
  activeTypeOptionText: { color: '#1976D2' },
  imageUpload: {
  ...
  changeImageText: { fontSize: 14, color: '#1976D2', fontWeight: '600' },
  ...
  removeSubImageText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  addSubImageButton: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#f8f9fa',
  ...
  addSubImageIcon: { fontSize: 20, color: '#2E7D32', marginRight: 8 },
  addSubImageText: { fontSize: 14, color: '#2E7D32', fontWeight: '600' },
  ...
  activeFeatureOption: { backgroundColor: '#E3F2FD', borderColor: '#1976D2' },
  featureOptionText: { fontSize: 14, fontWeight: '600', color: '#666' },
  activeFeatureOptionText: { color: '#1976D2' },
  ...
  addFeatureButtonText: { color: '#fff', fontSize: 14, fontWeight: '600' },
